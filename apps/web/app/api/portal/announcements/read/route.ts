...
// POST /api/portal/announcements/read
// Body: { announcement_id: string }
// Marks a specific announcement as read for the authenticated job seeker.
export async function POST(req: NextRequest) {
  ...
  // Verify this announcement targets seekers
  ...
  if (
    !announcement ||
    !["all_job_seekers", "all_users"].includes(announcement.target_audience)
  ) {
