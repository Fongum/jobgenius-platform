...
import SeekerDetailClient from "../../../seekers/[id]/SeekerDetailClient";

interface PageProps {
  params: { id: string };
}

export default async function AdminSeekerDetailPage({ params }: PageProps) {
  ...
  return (
    <SeekerDetailClient
      backHref="/dashboard/admin/job-seekers"
      seeker={seeker}
