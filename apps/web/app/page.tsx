    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-20 sm:pt-40 sm:pb-28 bg-gradient-to-b from-violet-50/60 via-white to-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-4xl">
          ...
          <p className="mt-6 text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            We handle the entire job search &mdash; applications, recruiter outreach,
            and follow-ups &mdash; so you can focus on the only thing that
            matters: <strong className="text-gray-900">nailing your interviews.</strong>
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-10">
            ...
            <div className="relative">
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                manager applies, reaches out to recruiters, follows up, and
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <FeatureCard
              ...
              description="See exactly where you stand: applications sent, responses received, interviews scheduled, scores improving. Full transparency."
            />
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <ul className="space-y-4">
                ...
                <BulletPoint text="Your manager reviews the top matches and handles applications and outreach" />
            ...
            <div className="bg-gradient-to-br from-violet-50 to-orange-50 rounded-2xl p-8 sm:p-10 border border-violet-100">
              <div className="space-y-6">
                ...
                <ComparisonRow label="Follow-ups" ai="Tracks timelines & triggers reminders" human="Sends thoughtful check-ins" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="interview-prep" className="py-20 sm:py-28 bg-gradient-to-b from-violet-600 to-violet-800 text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
          ...
          <p className="text-center text-violet-200 max-w-2xl mx-auto mb-16 text-lg">
      ...
      <section id="referral-network" className="py-20 sm:py-28">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1 bg-gradient-to-br from-violet-50 to-orange-50 rounded-2xl p-8 sm:p-10 border border-violet-100">
              <div className="space-y-5">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">Company Partnerships</h4>
                    <p className="text-sm text-gray-600 mt-1">
                      We work directly with companies looking to hire. When a
                      role matches your profile, we get you in front of them
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">Recruiter Network</h4>
                    <p className="text-sm text-gray-600 mt-1">
                      Our growing network of recruiters and staffing partners
                      means more doors open for you. When they have an opening,
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      When a new opportunity surfaces through our network that
                      matches your profile, we move fast. You get notified and
                      prepped before anyone else.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="order-1 md:order-2">
              ...
              <p className="text-lg text-gray-600 leading-relaxed mb-6">
                Most job seekers compete on job boards against thousands of
                applicants. Our referral network gives you a different path
                entirely.
              </p>
              <p className="text-gray-600 leading-relaxed">
                We partner with recruiters and companies who trust us to send
                them qualified candidates. When they have an opening that fits
                your skills, we put you in front of them &mdash; often before
                the role is even posted publicly.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <div className="text-sm text-gray-500 mt-1">Faster Placement</div>
            </div>
            <div>
              <div className="text-3xl sm:text-4xl font-extrabold text-violet-600">85%</div>
              <div className="text-sm text-gray-500 mt-1">Interview Pass Rate</div>
            </div>
            <div>
              <div className="text-3xl sm:text-4xl font-extrabold text-orange-500">0hrs</div>
              <div className="text-sm text-gray-500 mt-1">You Spend Applying</div>
            </div>
            <div>
              <div className="text-3xl sm:text-4xl font-extrabold text-violet-600">24/7</div>
              <div className="text-sm text-gray-500 mt-1">AI Working For You</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="pricing" className="py-20 sm:py-28">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
          ...
          <p className="text-center text-gray-500 max-w-2xl mx-auto mb-16">
            Two plans, both include a dedicated account manager and our full AI
            engine. You only pay a success fee when you land an offer.
          </p>
      ...
      <section className="py-20 sm:py-28 bg-gray-900">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl text-center">
          ...
          <p className="text-lg text-gray-400 mb-10 max-w-xl mx-auto">
            Your dedicated team is ready. AI working around the clock. A human
            account manager in your corner. Interview prep that actually works.
          </p>
          <Link
            href="/signup"
          ...
          <div className="grid sm:grid-cols-3 gap-8 mb-10">
            <div>
              ...
              <p className="text-sm leading-relaxed">
                ...
                applications so you can focus on interviews.
              </p>
            </div>
            <div>
